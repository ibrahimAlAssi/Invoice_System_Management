...
@section('content')
                            ...
                            <tbody>
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td><span style="color:slategrey;">{{ $invoice->section->section_name }}</span></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    <a class="dropdown-item" href="#update_invoice{{$invoice->id }}"
                                                        data-toggle="modal"><i
                                                            class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي
                                                        الفواتير</a>
                                                    <a class="dropdown-item" href="#delete_invoice{{$invoice->id}}"
                                                        data-toggle="modal" ><i
    ...
    <!--الغاء الارشفة-->
    <div class="modal fade" id="update_invoice{{$invoice->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
