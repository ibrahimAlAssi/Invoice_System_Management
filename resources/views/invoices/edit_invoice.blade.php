                    ...
                    <form action="{{url('invoices/update')}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission" value="{{$invoice->amount_comission }}"
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                ...
                sumq = parseFloat(intResults).toFixed(3);
