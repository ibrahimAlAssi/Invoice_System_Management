                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        $count_invoice2 = App\Models\invoice::where('value_status', 2)->count();
                                        if ($count_invoice2 == 0) {
                                            echo '%' . ($count_invoice2 = 0);
                                        } else {
                                            $count_invoice2 = ($count_invoice2 / $count_all) * 100;
                                            echo '%' . round($count_invoice2);
                                        }
                                    @endphp
                                </span>
                            </span>
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        $count_all = App\Models\invoice::count();
                                        $count_invoice2 = App\Models\invoice::where('value_status', 1)->count();
                                        if ($count_invoice2 == 0) {
                                            echo '%' . ($count_invoice2 = 0);
                                        } else {
                                            $count_invoice2 = ($count_invoice2 / $count_all) * 100;
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        $count_all = App\Models\invoice::count();
                                        $count_invoice2 = App\Models\invoice::where('value_status', 3)->count();
                                        if ($count_invoice2 == 0) {
                                            echo '%' . ($count_invoice2 = 0);
                                        } else {
                                            $count_invoice2 = ($count_invoice2 / $count_all) * 100;
    ...
    <div class="row row-sm">
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                <label class="main-content-label"> <h4 class="card-title mb-0">نسبة احصائية الفواتير</h4></label>
                <div class="">
                    {!! $chartjs_2->render() !!}
                </div>
            </div>
